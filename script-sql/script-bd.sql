...
*/
-- Mostrar todas las �reas y organizarlas en orden a - z.
SELECT IdArea, Nombre, Funcion, Observacion FROM Areas ORDER BY Nombre
GO
-- Mostrar lista de empleados y organizarlas por �reas en orden a - z
...
GO
-- Mostrar lista de todos los equipos que estan registrados en un area espec�fico.
DECLARE @area int = 1
